...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        self.Show()
        speak.Speak("Welcome back Sir, Broono at your service. Your system is ready and operational. How can I help")
...
#News
        if put.startswith('science '):
            try:
                ...
                i=1
                speak.Speak('here are some top science news from new scientist')
                print('             ================NEW SCIENTIST==============='+'\n')
